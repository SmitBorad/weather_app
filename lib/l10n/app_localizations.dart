...
abstract class AppLocalizations {
  ...
  /// No description provided for @locationServiceNeeded.
  ///
  /// In en, this message translates to:
  /// **'Location service needed'**
  String get locationServiceNeeded;

  /// No description provided for @locationPermissionNeededDis.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @failedToSearchLocation.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @showTemperatureLayer.
  ///
  /// In en, this message translates to:
  /// **'Show Temperature Layer'**
  String get showTemperatureLayer;

  /// No description provided for @showPrecipitationLayer.
  ///
  /// In en, this message translates to:
  /// **'Show Precipitation Layer'**
  String get showPrecipitationLayer;
